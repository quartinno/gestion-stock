...
import QuantixaOverlay from '../assets/images/Quantixa overlay.svg';
    ...
    <div className="relative w-full min-h-screen m-0 p-0 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="relative">
          {/* Quantixa Overlay - Positioned before TrustedBy */}
          <div className="overlay-container">
            <img 
              src={QuantixaOverlay} 
              alt="Quantixa overlay" 
              className="quantixa-overlay"
            />
          </div>
